""" Reproduce the results of the Example 6.7 `Maximization Bias Example` in Sutton's book
...
print("")
print("reprodcue the results of `Maximization Bias Example`")
...
plt.plot(episodes, optimal_array, color='k', linestyle='--', label='optimal')
...
plt.show()
fig.savefig('../images/maximization_bias_reproduce.eps')
fig.savefig('../images/maximization_bias_reproduce.png')
